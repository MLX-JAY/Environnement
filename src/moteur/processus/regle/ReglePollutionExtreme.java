...
public class ReglePollutionExtreme implements RegleTransformation {
    ...
    private static final Logger logger = LoggerUtility.getLogger(ReglePollutionExtreme.class);

    @Override
    public Biome evaluer(Biome biome) {
        logger.debug("[Evaluation] ReglePollutionExtreme pour " + biome.getClass().getSimpleName() + 
        ...
        logger.debug("[NonApplicable] ReglePollutionExtreme");
        return null;
    }
}
